...
function hundleKeyUp(e) {
    if (e.key === "Enter") {
        ...
        console.log(input.value);//we can see here whats typed inside the input on console.
      ...
      const newLI = document.createElement("li");//Quando a tecla enter e apertada, ira criar um novo li, para o proximo item da lista.
